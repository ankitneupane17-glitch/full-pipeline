pipeline {
    ...
    environment {
        ...
        IMAGE_NAME     = "fintech-python-app-ankit" // Add your name here
        CONTAINER_NAME = "fintech-prod-container-ankit" // Add your name here
        
        // ZAP Configuration
        ZAP_PORT       = "9006" // Change the port
        
        // Map Cosign Credentials
        COSIGN_PASSWORD = credentials('cosign-private-key')
        SONAR_SERVER_NAME = "sonar-server-admin"
        SONAR_PROJECT_KEY = "fintech-app-ankit" // Add your name here
    }
